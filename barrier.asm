...
int main()
{
  ...
  20:	75 ef                	jne    11 <main+0x11>
    ...
    for (i = 0; i < PROCESS_NUMBER; i++)
        wait();
  22:	e8 b3 02 00 00       	call   2da <wait>
  27:	e8 ae 02 00 00       	call   2da <wait>
  2c:	e8 a9 02 00 00       	call   2da <wait>
  31:	e8 a4 02 00 00       	call   2da <wait>
  36:	e8 9f 02 00 00       	call   2da <wait>
    exit();
  3b:	e8 92 02 00 00       	call   2d2 <exit>
            printf(1, "%dth proccess starts to proccessing\n", i+1);
  40:	50                   	push   %eax
  41:	53                   	push   %ebx
  42:	68 88 07 00 00       	push   $0x788
  47:	6a 01                	push   $0x1
  49:	e8 e2 03 00 00       	call   430 <printf>
            printf(1, "%dth proccess waits for other process to arrive\n", i+1);
  4e:	83 c4 0c             	add    $0xc,%esp
  51:	53                   	push   %ebx
  52:	68 b0 07 00 00       	push   $0x7b0
  57:	6a 01                	push   $0x1
  59:	e8 d2 03 00 00       	call   430 <printf>
            barrier(PROCESS_NUMBER);
  5e:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  65:	e8 10 03 00 00       	call   37a <barrier>
            printf(1, "%dth proccess finished proccessing\n", i+1);
  6a:	83 c4 0c             	add    $0xc,%esp
  6d:	53                   	push   %ebx
  6e:	68 e4 07 00 00       	push   $0x7e4
  73:	6a 01                	push   $0x1
  75:	e8 b6 03 00 00       	call   430 <printf>
            exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 08 08 00 00       	mov    $0x808,%ebx
        while(*s != 0){
 ...
 601:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 757:	0a 00 00 
 75a:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 bc 0a 00 00       	mov    $0xabc,%eax
 769:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 770:	00 00 00 
