...
int main()
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    ...
    pid = fork();
  11:	e8 d4 02 00 00       	call   2ea <fork>
    if (pid > 0)
  16:	83 f8 00             	cmp    $0x0,%eax
  19:	7f 16                	jg     31 <main+0x31>
            //     sum += i;
  ...
  1b:	74 51                	je     6e <main+0x6e>
    ...
    wait();
  1d:	e8 d8 02 00 00       	call   2fa <wait>
    wait();
  22:	e8 d3 02 00 00       	call   2fa <wait>
  ...
  48:	58                   	pop    %eax
  49:	5a                   	pop    %edx
  4a:	68 a8 07 00 00       	push   $0x7a8
  4f:	6a 01                	push   $0x1
  51:	e8 fa 03 00 00       	call   450 <printf>
            barrier();
  56:	e8 3f 03 00 00       	call   39a <barrier>
            printf(1,"%d  vA %d bbbbbbbbbbbbbb\n");
  5b:	59                   	pop    %ecx
  5c:	58                   	pop    %eax
  5d:	68 c2 07 00 00       	push   $0x7c2
  62:	6a 01                	push   $0x1
  ...
  77:	e8 d4 03 00 00       	call   450 <printf>
        barrier();
  7c:	e8 19 03 00 00       	call   39a <barrier>
        printf(1,"%d  vA %d sssssssssssss\n");
  81:	5a                   	pop    %edx
  82:	59                   	pop    %ecx
  83:	68 f4 07 00 00       	push   $0x7f4
  88:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 0d 08 00 00       	mov    $0x80d,%ebx
        while(*s != 0){
