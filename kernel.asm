...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 e7 79 10 80 	movl   $0x801079e7,(%esp)
...
80101265:	e8 46 33 00 00       	call   801045b0 <memset>
  log_write(bp);
...
8010130f:	e8 ec 31 00 00       	call   80104500 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 be 31 00 00       	call   80104500 <release>
      return ip;
...
80101461:	e8 fa 31 00 00       	call   80104660 <memmove>
  brelse(bp);
...
8010158e:	e8 1d 30 00 00       	call   801045b0 <memset>
      dip->type = type;
...
80101631:	e8 2a 30 00 00       	call   80104660 <memmove>
  log_write(bp);
...
8010166f:	e8 8c 2e 00 00       	call   80104500 <release>
}
...
80101718:	e8 43 2f 00 00       	call   80104660 <memmove>
    brelse(bp);
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 fb 2c 00 00       	jmp    80104500 <release>
...
8010181f:	e8 dc 2c 00 00       	call   80104500 <release>
    if(r == 1){
...
80101a05:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a07:	e8 54 2c 00 00       	call   80104660 <memmove>
    brelse(bp);
...
80101b03:	e8 58 2b 00 00       	call   80104660 <memmove>
    log_write(bp);
...
80101b9e:	e8 2d 2b 00 00       	call   801046d0 <strncmp>
}
80101ba3:	c9                   	leave  
80101ba4:	c3                   	ret    
...
80101bfd:	e8 ce 2a 00 00       	call   801046d0 <strncmp>
      continue;
...
80101c99:	e8 62 28 00 00       	call   80104500 <release>
...
80101cf5:	e8 66 29 00 00       	call   80104660 <memmove>
    path++;
...
80101d88:	e8 d3 28 00 00       	call   80104660 <memmove>
    name[len] = 0;
...
80101e7d:	e8 ae 28 00 00       	call   80104730 <strncpy>
  de.inum = inum;
...
8010210f:	e8 ec 23 00 00       	call   80104500 <release>
...
801021d5:	c9                   	leave  
  release(&idelock);
801021d6:	e9 25 23 00 00       	jmp    80104500 <release>
801021db:	90                   	nop
...
80102342:	e8 69 22 00 00       	call   801045b0 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 80 21 00 00       	jmp    80104500 <release>
    acquire(&kmem.lock);
...
80102521:	e8 da 1f 00 00       	call   80104500 <release>
  return (char*)r;
...
80102937:	e8 c4 1c 00 00       	call   80104600 <memcmp>
...
80102a64:	e8 f7 1b 00 00       	call   80104660 <memmove>
...
80102bfc:	e8 ff 18 00 00       	call   80104500 <release>
      break;
    }
  }
}
...
80102c5c:	e8 9f 18 00 00       	call   80104500 <release>
}
...
80102cb6:	e8 a5 19 00 00       	call   80104660 <memmove>
...
80102d21:	e8 da 17 00 00       	call   80104500 <release>
...
80102d4c:	e8 af 17 00 00       	call   80104500 <release>
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 fe 16 00 00       	jmp    80104500 <release>
...
80102f14:	e8 47 17 00 00       	call   80104660 <memmove>
...
80102ff4:	e8 07 16 00 00       	call   80104600 <memcmp>
...
801030b2:	e8 49 15 00 00       	call   80104600 <memcmp>
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 57 11 00 00       	jmp    80104500 <release>
...
801033d4:	e8 27 11 00 00       	call   80104500 <release>
    kfree((char*)p);
...
80103494:	e8 67 10 00 00       	call   80104500 <release>
        return -1;
...
801034eb:	e8 10 10 00 00       	call   80104500 <release>
  return n;
...
8010357e:	e8 7d 0f 00 00       	call   80104500 <release>
      return -1;
...
801035df:	e8 1c 0f 00 00       	call   80104500 <release>
  return i;
...
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 a9 0e 00 00       	call   80104500 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 dc 57 10 80 	movl   $0x801057dc,0x14(%eax)
  p->context = (struct context*)sp;
...
801036aa:	e8 51 0e 00 00       	call   80104500 <release>
}
...
801036db:	e8 20 0e 00 00       	call   80104500 <release>
...
80103856:	e8 55 0d 00 00       	call   801045b0 <memset>
...
801038b5:	e8 d6 0e 00 00       	call   80104790 <safestrcpy>
  p->cwd = namei("/");
...
801038e3:	e8 18 0c 00 00       	call   80104500 <release>
}
...
80103a31:	e8 5a 0d 00 00       	call   80104790 <safestrcpy>
  pid = np->pid;
...
80103a53:	e8 a8 0a 00 00       	call   80104500 <release>
  return pid;
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 e4 0c 00 00       	call   801047eb <swtch>
      switchkvm();
...
80103b2c:	e8 cf 09 00 00       	call   80104500 <release>
    sti();
...
80103ba3:	e8 43 0c 00 00       	call   801047eb <swtch>
  mycpu()->intena = intena;
...
80103d69:	e8 92 07 00 00       	call   80104500 <release>
}
...
80103dc8:	e8 33 07 00 00       	call   80104500 <release>
  p->chan = chan;
...
80103dea:	e8 11 07 00 00       	call   80104500 <release>
    acquire(lk);
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 52 2e 00 00       	call   80106d30 <freevm>
        release(&ptable.lock);
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 f6 05 00 00       	call   80104500 <release>
        return pid;
...
80103f23:	e8 d8 05 00 00       	call   80104500 <release>
      return -1;
...
80103f80:	c9                   	leave  
  release(&ptable.lock);
80103f81:	e9 7a 05 00 00       	jmp    80104500 <release>
...
80103fdb:	e8 20 05 00 00       	call   80104500 <release>
      return 0;
...
80103ff8:	e8 03 05 00 00       	call   80104500 <release>
  return -1;
...
8010402b:	68 e7 79 10 80       	push   $0x801079e7
...
8010411f:	e8 4c 02 00 00       	call   80104370 <acquire>
  while (lk->locked) {
...
8010415c:	5d                   	pop    %ebp
  release(&lk->lk);
8010415d:	e9 9e 03 00 00       	jmp    80104500 <release>
...
8010417f:	e8 ec 01 00 00       	call   80104370 <acquire>
  lk->locked = 0;
...
801041a4:	5d                   	pop    %ebp
  release(&lk->lk);
801041a5:	e9 56 03 00 00       	jmp    80104500 <release>
...
801041c2:	e8 a9 01 00 00       	call   80104370 <acquire>
...
801041e7:	e8 14 03 00 00       	call   80104500 <release>
  return r;
}
...
80104220 <initReentrantSpinlock>:
...
80104226:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->pid = -1;
80104229:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
  lk->name = name;
8010422f:	89 50 08             	mov    %edx,0x8(%eax)
  lk->locked = 0;
80104232:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  lk->cpu = 0;
80104239:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  initlock(&(lk->sl), name);
}
80104240:	5d                   	pop    %ebp
80104241:	c3                   	ret    
...
80104325:	68 e3 76 10 80       	push   $0x801076e3
8010432a:	e8 61 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010432f:	83 ec 0c             	sub    $0xc,%esp
80104332:	68 fa 76 10 80       	push   $0x801076fa
...
80104417:	68 01 77 10 80       	push   $0x80107701
8010441c:	e8 6f bf ff ff       	call   80100390 <panic>
80104421:	eb 0d                	jmp    80104430 <acquireReentrant>
80104423:	90                   	nop
80104424:	90                   	nop
80104425:	90                   	nop
80104426:	90                   	nop
...
80104436:	83 ec 0c             	sub    $0xc,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80104439:	e8 62 fe ff ff       	call   801042a0 <pushcli>
  int proccessId = myproc()->pid;
8010443e:	e8 9d f3 ff ff       	call   801037e0 <myproc>
  if (holding(&(lk->sl)) && lk->pid == proccessId) {
80104443:	8b 7d 08             	mov    0x8(%ebp),%edi
80104446:	83 ec 0c             	sub    $0xc,%esp
  int proccessId = myproc()->pid;
80104449:	8b 70 10             	mov    0x10(%eax),%esi
  if (holding(&(lk->sl)) && lk->pid == proccessId) {
8010444c:	8d 5f 04             	lea    0x4(%edi),%ebx
8010444f:	53                   	push   %ebx
80104450:	e8 eb fe ff ff       	call   80104340 <holding>
80104455:	83 c4 10             	add    $0x10,%esp
80104458:	85 c0                	test   %eax,%eax
8010445a:	74 08                	je     80104464 <acquireReentrant+0x34>
8010445c:	39 37                	cmp    %esi,(%edi)
8010445e:	0f 84 94 00 00 00    	je     801044f8 <acquireReentrant+0xc8>
80104464:	ba 01 00 00 00       	mov    $0x1,%edx
80104469:	eb 0b                	jmp    80104476 <acquireReentrant+0x46>
8010446b:	90                   	nop
8010446c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104470:	8b 45 08             	mov    0x8(%ebp),%eax
80104473:	8d 58 04             	lea    0x4(%eax),%ebx
80104476:	89 d0                	mov    %edx,%eax
80104478:	f0 87 03             	lock xchg %eax,(%ebx)
  while(xchg(&((lk->sl).locked), 1) != 0)
8010447b:	85 c0                	test   %eax,%eax
8010447d:	75 f1                	jne    80104470 <acquireReentrant+0x40>
  __sync_synchronize();
8010447f:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  (lk->sl).cpu = mycpu();
80104484:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104487:	e8 b4 f2 ff ff       	call   80103740 <mycpu>
  for(i = 0; i < 10; i++){
8010448c:	31 d2                	xor    %edx,%edx
  getcallerpcs(&lk, (lk->sl).pcs);  
8010448e:	8d 4b 10             	lea    0x10(%ebx),%ecx
  (lk->sl).cpu = mycpu();
80104491:	89 43 0c             	mov    %eax,0xc(%ebx)
  lk->pid = proccessId;
80104494:	89 33                	mov    %esi,(%ebx)
  ebp = (uint*)v - 2;
80104496:	89 e8                	mov    %ebp,%eax
80104498:	90                   	nop
...
801044ac:	77 22                	ja     801044d0 <acquireReentrant+0xa0>
    pcs[i] = ebp[1];     // saved %eip
...
801044bc:	75 e2                	jne    801044a0 <acquireReentrant+0x70>
}
...
801044eb:	75 f3                	jne    801044e0 <acquireReentrant+0xb0>
}
...
801044f5:	8d 76 00             	lea    0x0(%esi),%esi
    popcli();
801044f8:	e8 e3 fd ff ff       	call   801042e0 <popcli>
    return;
801044fd:	eb bf                	jmp    801044be <acquireReentrant+0x8e>
801044ff:	90                   	nop
...
8010450b:	e8 30 fe ff ff       	call   80104340 <holding>
...
80104533:	c9                   	leave  
  popcli();
80104534:	e9 a7 fd ff ff       	jmp    801042e0 <popcli>
    panic("release");
80104539:	83 ec 0c             	sub    $0xc,%esp
8010453c:	68 09 77 10 80       	push   $0x80107709
...
8010455b:	8d 43 04             	lea    0x4(%ebx),%eax
8010455e:	50                   	push   %eax
8010455f:	e8 dc fd ff ff       	call   80104340 <holding>
80104564:	83 c4 10             	add    $0x10,%esp
80104567:	85 c0                	test   %eax,%eax
80104569:	74 31                	je     8010459c <releaseReentrant+0x4c>
8010456b:	8b 33                	mov    (%ebx),%esi
8010456d:	e8 6e f2 ff ff       	call   801037e0 <myproc>
80104572:	3b 70 10             	cmp    0x10(%eax),%esi
80104575:	75 25                	jne    8010459c <releaseReentrant+0x4c>
  (lk->sl).pcs[0] = 0;
80104577:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
  (lk->sl).cpu = 0;
8010457e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  __sync_synchronize();
80104585:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" ((lk->sl).locked) : );
8010458a:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
80104591:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104594:	5b                   	pop    %ebx
80104595:	5e                   	pop    %esi
80104596:	5d                   	pop    %ebp
  popcli();  
80104597:	e9 44 fd ff ff       	jmp    801042e0 <popcli>
    panic("release");
8010459c:	83 ec 0c             	sub    $0xc,%esp
8010459f:	68 09 77 10 80       	push   $0x80107709
801045a4:	e8 e7 bd ff ff       	call   80100390 <panic>
...
801048b5:	e8 26 ef ff ff       	call   801037e0 <myproc>
...
801048c3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801048c6:	e8 15 ef ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104908:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010490b:	e8 d0 ee ff ff       	call   801037e0 <myproc>
...
801049a0 <syscall>:
[SYS_acquireTest]  sys_acquireTest,
};
...
801049a4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801049a7:	e8 34 ee ff ff       	call   801037e0 <myproc>
...
801049bc:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
...
80104a17:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a1a:	e8 e1 d4 ff ff       	call   80101f00 <nameiparent>
...
80104a3c:	e8 6f d1 ff ff       	call   80101bb0 <dirlookup>
80104a41:	83 c4 10             	add    $0x10,%esp
80104a44:	85 c0                	test   %eax,%eax
80104a46:	89 c7                	mov    %eax,%edi
80104a48:	74 36                	je     80104a80 <create+0x80>
    iunlockput(dp);
80104a4a:	83 ec 0c             	sub    $0xc,%esp
80104a4d:	53                   	push   %ebx
80104a4e:	e8 bd ce ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104a53:	89 3c 24             	mov    %edi,(%esp)
80104a56:	e8 25 cc ff ff       	call   80101680 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104a5b:	83 c4 10             	add    $0x10,%esp
80104a5e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104a63:	0f 85 97 00 00 00    	jne    80104b00 <create+0x100>
80104a69:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104a6e:	0f 85 8c 00 00 00    	jne    80104b00 <create+0x100>
...
80104a8a:	e8 81 ca ff ff       	call   80101510 <ialloc>
...
80104ac1:	e8 0a cb ff ff       	call   801015d0 <iupdate>
...
80104ad8:	e8 43 d3 ff ff       	call   80101e20 <dirlink>
...
80104aec:	e8 1f ce ff ff       	call   80101910 <iunlockput>
  return ip;
...
80104b04:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104b06:	e8 05 ce ff ff       	call   80101910 <iunlockput>
    return 0;
...
80104b29:	e8 a2 ca ff ff       	call   801015d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b2e:	83 c4 0c             	add    $0xc,%esp
80104b31:	ff 77 04             	pushl  0x4(%edi)
80104b34:	68 b8 77 10 80       	push   $0x801077b8
...
80104b4c:	68 b7 77 10 80       	push   $0x801077b7
80104b51:	57                   	push   %edi
80104b52:	e8 c9 d2 ff ff       	call   80101e20 <dirlink>
...
80104bc4:	e8 17 ec ff ff       	call   801037e0 <myproc>
...
80104c09:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c0b:	e8 d0 eb ff ff       	call   801037e0 <myproc>
...
80104d53:	78 2b                	js     80104d80 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d55:	e8 86 ea ff ff       	call   801037e0 <myproc>
...
80104e12:	0f 88 e2 00 00 00    	js     80104efa <sys_link+0x11a>
  begin_op();
80104e18:	e8 83 dd ff ff       	call   80102ba0 <begin_op>
  if((ip = namei(old)) == 0){
80104e1d:	83 ec 0c             	sub    $0xc,%esp
80104e20:	ff 75 d4             	pushl  -0x2c(%ebp)
80104e23:	e8 b8 d0 ff ff       	call   80101ee0 <namei>
...
80104e58:	e8 73 c7 ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
80104e5d:	89 1c 24             	mov    %ebx,(%esp)
80104e60:	e8 fb c8 ff ff       	call   80101760 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104e65:	58                   	pop    %eax
80104e66:	5a                   	pop    %edx
80104e67:	57                   	push   %edi
80104e68:	ff 75 d0             	pushl  -0x30(%ebp)
80104e6b:	e8 90 d0 ff ff       	call   80101f00 <nameiparent>
...
80104e7d:	e8 fe c7 ff ff       	call   80101680 <ilock>
...
80104e93:	e8 88 cf ff ff       	call   80101e20 <dirlink>
...
80104eab:	e8 00 c9 ff ff       	call   801017b0 <iput>
  end_op();
80104eb0:	e8 5b dd ff ff       	call   80102c10 <end_op>
  return 0;
...
80104f1d:	eb 9b                	jmp    80104eba <sys_link+0xda>
    end_op();
80104f1f:	e8 ec dc ff ff       	call   80102c10 <end_op>
    return -1;
...
80104f4f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104f52:	e8 49 dc ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104f57:	83 ec 08             	sub    $0x8,%esp
80104f5a:	53                   	push   %ebx
80104f5b:	ff 75 c0             	pushl  -0x40(%ebp)
80104f5e:	e8 9d cf ff ff       	call   80101f00 <nameiparent>
...
80104f74:	e8 07 c7 ff ff       	call   80101680 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104f79:	58                   	pop    %eax
80104f7a:	5a                   	pop    %edx
80104f7b:	68 b8 77 10 80       	push   $0x801077b8
80104f80:	53                   	push   %ebx
80104f81:	e8 0a cc ff ff       	call   80101b90 <namecmp>
...
80104f94:	68 b7 77 10 80       	push   $0x801077b7
80104f99:	53                   	push   %ebx
80104f9a:	e8 f1 cb ff ff       	call   80101b90 <namecmp>
...
80104fb3:	e8 f8 cb ff ff       	call   80101bb0 <dirlookup>
...
80104ffd:	e8 5e ca ff ff       	call   80101a60 <writei>
...
8010502a:	e8 a1 c5 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
8010502f:	89 1c 24             	mov    %ebx,(%esp)
80105032:	e8 d9 c8 ff ff       	call   80101910 <iunlockput>
  end_op();
80105037:	e8 d4 db ff ff       	call   80102c10 <end_op>
  return 0;
...
80105074:	e8 e7 c8 ff ff       	call   80101960 <readi>
...
80105098:	e8 73 c8 ff ff       	call   80101910 <iunlockput>
  end_op();
8010509d:	e8 6e db ff ff       	call   80102c10 <end_op>
  return -1;
...
801050b9:	e8 12 c5 ff ff       	call   801015d0 <iupdate>
...
8010515d:	e8 7e cd ff ff       	call   80101ee0 <namei>
...
80105173:	e8 08 c5 ff ff       	call   80101680 <ilock>
...
8010518f:	0f 84 a6 00 00 00    	je     8010523b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105195:	e8 46 e6 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801051bc:	e8 9f c5 ff ff       	call   80101760 <iunlock>
  end_op();
801051c1:	e8 4a da ff ff       	call   80102c10 <end_op>
...
80105273:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105276:	e8 25 d9 ff ff       	call   80102ba0 <begin_op>
...
8010533e:	e8 cd c5 ff ff       	call   80101910 <iunlockput>
  end_op();
80105343:	e8 c8 d8 ff ff       	call   80102c10 <end_op>
  return 0;
...
80105365:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105368:	e8 73 e4 ff ff       	call   801037e0 <myproc>
8010536d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010536f:	e8 2c d8 ff ff       	call   80102ba0 <begin_op>
...
8010538f:	e8 4c cb ff ff       	call   80101ee0 <namei>
...
801053a1:	e8 da c2 ff ff       	call   80101680 <ilock>
  if(ip->type != T_DIR){
...
801053b4:	e8 a7 c3 ff ff       	call   80101760 <iunlock>
  iput(curproc->cwd);
801053b9:	58                   	pop    %eax
801053ba:	ff 76 68             	pushl  0x68(%esi)
801053bd:	e8 ee c3 ff ff       	call   801017b0 <iput>
  end_op();
801053c2:	e8 49 d8 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
...
801053e4:	e8 27 c5 ff ff       	call   80101910 <iunlockput>
    end_op();
801053e9:	e8 22 d8 ff ff       	call   80102c10 <end_op>
    return -1;
...
8010561c:	e8 8f f2 ff ff       	call   801048b0 <argint>
...
8010566d:	e8 3e f2 ff ff       	call   801048b0 <argint>
...
801056bd:	e8 ee f1 ff ff       	call   801048b0 <argint>
...
801056d5:	e8 96 ec ff ff       	call   80104370 <acquire>
  ticks0 = ticks;
...
80105725:	e8 d6 ed ff ff       	call   80104500 <release>
      return -1;
...
80105748:	e8 b3 ed ff ff       	call   80104500 <release>
  return 0;
...
80105794:	8d 5d c0             	lea    -0x40(%ebp),%ebx
sys_acquireTest(void) {
80105797:	83 ec 4c             	sub    $0x4c,%esp
  initReentrantSpinlock(&lk, "splinlock");
8010579a:	68 fd 77 10 80       	push   $0x801077fd
8010579f:	53                   	push   %ebx
801057a0:	e8 7b ea ff ff       	call   80104220 <initReentrantSpinlock>
  acquireReentrant(&lk);
801057a5:	89 1c 24             	mov    %ebx,(%esp)
801057a8:	e8 83 ec ff ff       	call   80104430 <acquireReentrant>
  acquireReentrant(&lk);
801057ad:	89 1c 24             	mov    %ebx,(%esp)
801057b0:	e8 7b ec ff ff       	call   80104430 <acquireReentrant>
  releaseReentrant(&lk);
801057b5:	89 1c 24             	mov    %ebx,(%esp)
801057b8:	e8 93 ed ff ff       	call   80104550 <releaseReentrant>
  return 0;
}
...
801057c5:	06                   	push   %es
  pushl %fs
801057c6:	0f a0                	push   %fs
  pushl %gs
801057c8:	0f a8                	push   %gs
  pushal
801057ca:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801057cb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801057cf:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801057d1:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801057d3:	54                   	push   %esp
  call trap
801057d4:	e8 c7 00 00 00       	call   801058a0 <trap>
  addl $4, %esp
801057d9:	83 c4 04             	add    $0x4,%esp
...
801057dc:	61                   	popa   
  popl %gs
801057dd:	0f a9                	pop    %gs
  popl %fs
801057df:	0f a1                	pop    %fs
  popl %es
801057e1:	07                   	pop    %es
  popl %ds
801057e2:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801057e3:	83 c4 08             	add    $0x8,%esp
  iret
801057e6:	cf                   	iret   
...
80105807:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
8010580e:	08 00 00 8e 
80105812:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105819:	80 
8010581a:	c1 ea 10             	shr    $0x10,%edx
8010581d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105824:	80 
  for(i = 0; i < 256; i++)
...
80105834:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105837:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
8010583e:	00 00 ef 
  initlock(&tickslock, "time");
80105841:	68 07 78 10 80       	push   $0x80107807
80105846:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010584b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105851:	c1 e8 10             	shr    $0x10,%eax
80105854:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
...
8010587b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010587f:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801058c0:	ff 24 85 b0 78 10 80 	jmp    *-0x7fef8750(,%eax,4)
...
80105925:	68 6c 78 10 80       	push   $0x8010786c
...
801059bd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059c0:	e8 db ef ff ff       	call   801049a0 <syscall>
    if(myproc()->killed)
...
80105a67:	68 14 78 10 80       	push   $0x80107814
...
80105a9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105aa0:	e8 5b e1 ff ff       	call   80103c00 <exit>
...
80105b05:	68 38 78 10 80       	push   $0x80107838
80105b0a:	e8 51 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b0f:	83 c4 14             	add    $0x14,%esp
80105b12:	68 0c 78 10 80       	push   $0x8010780c
...
80105c0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c0f:	bb 30 79 10 80       	mov    $0x80107930,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105ca7:	6a 00                	push   $0x0
  jmp alltraps
80105ca9:	e9 16 fb ff ff       	jmp    801057c4 <alltraps>
...
80105cb0:	6a 01                	push   $0x1
  jmp alltraps
80105cb2:	e9 0d fb ff ff       	jmp    801057c4 <alltraps>
...
80105cb9:	6a 02                	push   $0x2
  jmp alltraps
80105cbb:	e9 04 fb ff ff       	jmp    801057c4 <alltraps>
...
80105cc2:	6a 03                	push   $0x3
  jmp alltraps
80105cc4:	e9 fb fa ff ff       	jmp    801057c4 <alltraps>
...
80105ccb:	6a 04                	push   $0x4
  jmp alltraps
80105ccd:	e9 f2 fa ff ff       	jmp    801057c4 <alltraps>
...
80105cd4:	6a 05                	push   $0x5
  jmp alltraps
80105cd6:	e9 e9 fa ff ff       	jmp    801057c4 <alltraps>
...
80105cdd:	6a 06                	push   $0x6
  jmp alltraps
80105cdf:	e9 e0 fa ff ff       	jmp    801057c4 <alltraps>
...
80105ce6:	6a 07                	push   $0x7
  jmp alltraps
80105ce8:	e9 d7 fa ff ff       	jmp    801057c4 <alltraps>
...
80105ced:	6a 08                	push   $0x8
  jmp alltraps
80105cef:	e9 d0 fa ff ff       	jmp    801057c4 <alltraps>
...
80105cf6:	6a 09                	push   $0x9
  jmp alltraps
80105cf8:	e9 c7 fa ff ff       	jmp    801057c4 <alltraps>
...
80105cfd:	6a 0a                	push   $0xa
  jmp alltraps
80105cff:	e9 c0 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d04:	6a 0b                	push   $0xb
  jmp alltraps
80105d06:	e9 b9 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d0b:	6a 0c                	push   $0xc
  jmp alltraps
80105d0d:	e9 b2 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d12:	6a 0d                	push   $0xd
  jmp alltraps
80105d14:	e9 ab fa ff ff       	jmp    801057c4 <alltraps>
...
80105d19:	6a 0e                	push   $0xe
  jmp alltraps
80105d1b:	e9 a4 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d22:	6a 0f                	push   $0xf
  jmp alltraps
80105d24:	e9 9b fa ff ff       	jmp    801057c4 <alltraps>
...
80105d2b:	6a 10                	push   $0x10
  jmp alltraps
80105d2d:	e9 92 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d32:	6a 11                	push   $0x11
  jmp alltraps
80105d34:	e9 8b fa ff ff       	jmp    801057c4 <alltraps>
...
80105d3b:	6a 12                	push   $0x12
  jmp alltraps
80105d3d:	e9 82 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d44:	6a 13                	push   $0x13
  jmp alltraps
80105d46:	e9 79 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d4d:	6a 14                	push   $0x14
  jmp alltraps
80105d4f:	e9 70 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d56:	6a 15                	push   $0x15
  jmp alltraps
80105d58:	e9 67 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d5f:	6a 16                	push   $0x16
  jmp alltraps
80105d61:	e9 5e fa ff ff       	jmp    801057c4 <alltraps>
...
80105d68:	6a 17                	push   $0x17
  jmp alltraps
80105d6a:	e9 55 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d71:	6a 18                	push   $0x18
  jmp alltraps
80105d73:	e9 4c fa ff ff       	jmp    801057c4 <alltraps>
...
80105d7a:	6a 19                	push   $0x19
  jmp alltraps
80105d7c:	e9 43 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d83:	6a 1a                	push   $0x1a
  jmp alltraps
80105d85:	e9 3a fa ff ff       	jmp    801057c4 <alltraps>
...
80105d8c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d8e:	e9 31 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d95:	6a 1c                	push   $0x1c
  jmp alltraps
80105d97:	e9 28 fa ff ff       	jmp    801057c4 <alltraps>
...
80105d9e:	6a 1d                	push   $0x1d
  jmp alltraps
80105da0:	e9 1f fa ff ff       	jmp    801057c4 <alltraps>
...
80105da7:	6a 1e                	push   $0x1e
  jmp alltraps
80105da9:	e9 16 fa ff ff       	jmp    801057c4 <alltraps>
...
80105db0:	6a 1f                	push   $0x1f
  jmp alltraps
80105db2:	e9 0d fa ff ff       	jmp    801057c4 <alltraps>
...
80105db9:	6a 20                	push   $0x20
  jmp alltraps
80105dbb:	e9 04 fa ff ff       	jmp    801057c4 <alltraps>
...
80105dc2:	6a 21                	push   $0x21
  jmp alltraps
80105dc4:	e9 fb f9 ff ff       	jmp    801057c4 <alltraps>
...
80105dcb:	6a 22                	push   $0x22
  jmp alltraps
80105dcd:	e9 f2 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105dd4:	6a 23                	push   $0x23
  jmp alltraps
80105dd6:	e9 e9 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105ddd:	6a 24                	push   $0x24
  jmp alltraps
80105ddf:	e9 e0 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105de6:	6a 25                	push   $0x25
  jmp alltraps
80105de8:	e9 d7 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105def:	6a 26                	push   $0x26
  jmp alltraps
80105df1:	e9 ce f9 ff ff       	jmp    801057c4 <alltraps>
...
80105df8:	6a 27                	push   $0x27
  jmp alltraps
80105dfa:	e9 c5 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e01:	6a 28                	push   $0x28
  jmp alltraps
80105e03:	e9 bc f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e0a:	6a 29                	push   $0x29
  jmp alltraps
80105e0c:	e9 b3 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e13:	6a 2a                	push   $0x2a
  jmp alltraps
80105e15:	e9 aa f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e1c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e1e:	e9 a1 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e25:	6a 2c                	push   $0x2c
  jmp alltraps
80105e27:	e9 98 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e2e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e30:	e9 8f f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e37:	6a 2e                	push   $0x2e
  jmp alltraps
80105e39:	e9 86 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e40:	6a 2f                	push   $0x2f
  jmp alltraps
80105e42:	e9 7d f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e49:	6a 30                	push   $0x30
  jmp alltraps
80105e4b:	e9 74 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e52:	6a 31                	push   $0x31
  jmp alltraps
80105e54:	e9 6b f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e5b:	6a 32                	push   $0x32
  jmp alltraps
80105e5d:	e9 62 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e64:	6a 33                	push   $0x33
  jmp alltraps
80105e66:	e9 59 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e6d:	6a 34                	push   $0x34
  jmp alltraps
80105e6f:	e9 50 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e76:	6a 35                	push   $0x35
  jmp alltraps
80105e78:	e9 47 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e7f:	6a 36                	push   $0x36
  jmp alltraps
80105e81:	e9 3e f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e88:	6a 37                	push   $0x37
  jmp alltraps
80105e8a:	e9 35 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e91:	6a 38                	push   $0x38
  jmp alltraps
80105e93:	e9 2c f9 ff ff       	jmp    801057c4 <alltraps>
...
80105e9a:	6a 39                	push   $0x39
  jmp alltraps
80105e9c:	e9 23 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105ea3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ea5:	e9 1a f9 ff ff       	jmp    801057c4 <alltraps>
...
80105eac:	6a 3b                	push   $0x3b
  jmp alltraps
80105eae:	e9 11 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105eb5:	6a 3c                	push   $0x3c
  jmp alltraps
80105eb7:	e9 08 f9 ff ff       	jmp    801057c4 <alltraps>
...
80105ebe:	6a 3d                	push   $0x3d
  jmp alltraps
80105ec0:	e9 ff f8 ff ff       	jmp    801057c4 <alltraps>
...
80105ec7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ec9:	e9 f6 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105ed0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ed2:	e9 ed f8 ff ff       	jmp    801057c4 <alltraps>
...
80105ed9:	6a 40                	push   $0x40
  jmp alltraps
80105edb:	e9 e4 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105ee2:	6a 41                	push   $0x41
  jmp alltraps
80105ee4:	e9 db f8 ff ff       	jmp    801057c4 <alltraps>
...
80105eeb:	6a 42                	push   $0x42
  jmp alltraps
80105eed:	e9 d2 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105ef4:	6a 43                	push   $0x43
  jmp alltraps
80105ef6:	e9 c9 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105efd:	6a 44                	push   $0x44
  jmp alltraps
80105eff:	e9 c0 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f06:	6a 45                	push   $0x45
  jmp alltraps
80105f08:	e9 b7 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f0f:	6a 46                	push   $0x46
  jmp alltraps
80105f11:	e9 ae f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f18:	6a 47                	push   $0x47
  jmp alltraps
80105f1a:	e9 a5 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f21:	6a 48                	push   $0x48
  jmp alltraps
80105f23:	e9 9c f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f2a:	6a 49                	push   $0x49
  jmp alltraps
80105f2c:	e9 93 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f33:	6a 4a                	push   $0x4a
  jmp alltraps
80105f35:	e9 8a f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f3c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f3e:	e9 81 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f45:	6a 4c                	push   $0x4c
  jmp alltraps
80105f47:	e9 78 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f4e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f50:	e9 6f f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f57:	6a 4e                	push   $0x4e
  jmp alltraps
80105f59:	e9 66 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f60:	6a 4f                	push   $0x4f
  jmp alltraps
80105f62:	e9 5d f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f69:	6a 50                	push   $0x50
  jmp alltraps
80105f6b:	e9 54 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f72:	6a 51                	push   $0x51
  jmp alltraps
80105f74:	e9 4b f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f7b:	6a 52                	push   $0x52
  jmp alltraps
80105f7d:	e9 42 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f84:	6a 53                	push   $0x53
  jmp alltraps
80105f86:	e9 39 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f8d:	6a 54                	push   $0x54
  jmp alltraps
80105f8f:	e9 30 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f96:	6a 55                	push   $0x55
  jmp alltraps
80105f98:	e9 27 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105f9f:	6a 56                	push   $0x56
  jmp alltraps
80105fa1:	e9 1e f8 ff ff       	jmp    801057c4 <alltraps>
...
80105fa8:	6a 57                	push   $0x57
  jmp alltraps
80105faa:	e9 15 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105fb1:	6a 58                	push   $0x58
  jmp alltraps
80105fb3:	e9 0c f8 ff ff       	jmp    801057c4 <alltraps>
...
80105fba:	6a 59                	push   $0x59
  jmp alltraps
80105fbc:	e9 03 f8 ff ff       	jmp    801057c4 <alltraps>
...
80105fc3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fc5:	e9 fa f7 ff ff       	jmp    801057c4 <alltraps>
...
80105fcc:	6a 5b                	push   $0x5b
  jmp alltraps
80105fce:	e9 f1 f7 ff ff       	jmp    801057c4 <alltraps>
...
80105fd5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fd7:	e9 e8 f7 ff ff       	jmp    801057c4 <alltraps>
...
80105fde:	6a 5d                	push   $0x5d
  jmp alltraps
80105fe0:	e9 df f7 ff ff       	jmp    801057c4 <alltraps>
...
80105fe7:	6a 5e                	push   $0x5e
  jmp alltraps
80105fe9:	e9 d6 f7 ff ff       	jmp    801057c4 <alltraps>
...
80105ff0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ff2:	e9 cd f7 ff ff       	jmp    801057c4 <alltraps>
...
80105ff9:	6a 60                	push   $0x60
  jmp alltraps
80105ffb:	e9 c4 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106002:	6a 61                	push   $0x61
  jmp alltraps
80106004:	e9 bb f7 ff ff       	jmp    801057c4 <alltraps>
...
8010600b:	6a 62                	push   $0x62
  jmp alltraps
8010600d:	e9 b2 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106014:	6a 63                	push   $0x63
  jmp alltraps
80106016:	e9 a9 f7 ff ff       	jmp    801057c4 <alltraps>
...
8010601d:	6a 64                	push   $0x64
  jmp alltraps
8010601f:	e9 a0 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106026:	6a 65                	push   $0x65
  jmp alltraps
80106028:	e9 97 f7 ff ff       	jmp    801057c4 <alltraps>
...
8010602f:	6a 66                	push   $0x66
  jmp alltraps
80106031:	e9 8e f7 ff ff       	jmp    801057c4 <alltraps>
...
80106038:	6a 67                	push   $0x67
  jmp alltraps
8010603a:	e9 85 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106041:	6a 68                	push   $0x68
  jmp alltraps
80106043:	e9 7c f7 ff ff       	jmp    801057c4 <alltraps>
...
8010604a:	6a 69                	push   $0x69
  jmp alltraps
8010604c:	e9 73 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106053:	6a 6a                	push   $0x6a
  jmp alltraps
80106055:	e9 6a f7 ff ff       	jmp    801057c4 <alltraps>
...
8010605c:	6a 6b                	push   $0x6b
  jmp alltraps
8010605e:	e9 61 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106065:	6a 6c                	push   $0x6c
  jmp alltraps
80106067:	e9 58 f7 ff ff       	jmp    801057c4 <alltraps>
...
8010606e:	6a 6d                	push   $0x6d
  jmp alltraps
80106070:	e9 4f f7 ff ff       	jmp    801057c4 <alltraps>
...
80106077:	6a 6e                	push   $0x6e
  jmp alltraps
80106079:	e9 46 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106080:	6a 6f                	push   $0x6f
  jmp alltraps
80106082:	e9 3d f7 ff ff       	jmp    801057c4 <alltraps>
...
80106089:	6a 70                	push   $0x70
  jmp alltraps
8010608b:	e9 34 f7 ff ff       	jmp    801057c4 <alltraps>
...
80106092:	6a 71                	push   $0x71
  jmp alltraps
80106094:	e9 2b f7 ff ff       	jmp    801057c4 <alltraps>
...
8010609b:	6a 72                	push   $0x72
  jmp alltraps
8010609d:	e9 22 f7 ff ff       	jmp    801057c4 <alltraps>
...
801060a4:	6a 73                	push   $0x73
  jmp alltraps
801060a6:	e9 19 f7 ff ff       	jmp    801057c4 <alltraps>
...
801060ad:	6a 74                	push   $0x74
  jmp alltraps
801060af:	e9 10 f7 ff ff       	jmp    801057c4 <alltraps>
...
801060b6:	6a 75                	push   $0x75
  jmp alltraps
801060b8:	e9 07 f7 ff ff       	jmp    801057c4 <alltraps>
...
801060bf:	6a 76                	push   $0x76
  jmp alltraps
801060c1:	e9 fe f6 ff ff       	jmp    801057c4 <alltraps>
...
801060c8:	6a 77                	push   $0x77
  jmp alltraps
801060ca:	e9 f5 f6 ff ff       	jmp    801057c4 <alltraps>
...
801060d1:	6a 78                	push   $0x78
  jmp alltraps
801060d3:	e9 ec f6 ff ff       	jmp    801057c4 <alltraps>
...
801060da:	6a 79                	push   $0x79
  jmp alltraps
801060dc:	e9 e3 f6 ff ff       	jmp    801057c4 <alltraps>
...
801060e3:	6a 7a                	push   $0x7a
  jmp alltraps
801060e5:	e9 da f6 ff ff       	jmp    801057c4 <alltraps>
...
801060ec:	6a 7b                	push   $0x7b
  jmp alltraps
801060ee:	e9 d1 f6 ff ff       	jmp    801057c4 <alltraps>
...
801060f5:	6a 7c                	push   $0x7c
  jmp alltraps
801060f7:	e9 c8 f6 ff ff       	jmp    801057c4 <alltraps>
...
801060fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106100:	e9 bf f6 ff ff       	jmp    801057c4 <alltraps>
...
80106107:	6a 7e                	push   $0x7e
  jmp alltraps
80106109:	e9 b6 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106110:	6a 7f                	push   $0x7f
  jmp alltraps
80106112:	e9 ad f6 ff ff       	jmp    801057c4 <alltraps>
...
80106119:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010611e:	e9 a1 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106125:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010612a:	e9 95 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106131:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106136:	e9 89 f6 ff ff       	jmp    801057c4 <alltraps>
...
8010613d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106142:	e9 7d f6 ff ff       	jmp    801057c4 <alltraps>
...
80106149:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010614e:	e9 71 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106155:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010615a:	e9 65 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106161:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106166:	e9 59 f6 ff ff       	jmp    801057c4 <alltraps>
...
8010616d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106172:	e9 4d f6 ff ff       	jmp    801057c4 <alltraps>
...
80106179:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010617e:	e9 41 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106185:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010618a:	e9 35 f6 ff ff       	jmp    801057c4 <alltraps>
...
80106191:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106196:	e9 29 f6 ff ff       	jmp    801057c4 <alltraps>
...
8010619d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061a2:	e9 1d f6 ff ff       	jmp    801057c4 <alltraps>
...
801061a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ae:	e9 11 f6 ff ff       	jmp    801057c4 <alltraps>
...
801061b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061ba:	e9 05 f6 ff ff       	jmp    801057c4 <alltraps>
...
801061c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061c6:	e9 f9 f5 ff ff       	jmp    801057c4 <alltraps>
...
801061cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061d2:	e9 ed f5 ff ff       	jmp    801057c4 <alltraps>
...
801061d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061de:	e9 e1 f5 ff ff       	jmp    801057c4 <alltraps>
...
801061e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061ea:	e9 d5 f5 ff ff       	jmp    801057c4 <alltraps>
...
801061f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061f6:	e9 c9 f5 ff ff       	jmp    801057c4 <alltraps>
...
801061fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106202:	e9 bd f5 ff ff       	jmp    801057c4 <alltraps>
...
80106209:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010620e:	e9 b1 f5 ff ff       	jmp    801057c4 <alltraps>
...
80106215:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010621a:	e9 a5 f5 ff ff       	jmp    801057c4 <alltraps>
...
80106221:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106226:	e9 99 f5 ff ff       	jmp    801057c4 <alltraps>
...
8010622d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106232:	e9 8d f5 ff ff       	jmp    801057c4 <alltraps>
...
80106239:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010623e:	e9 81 f5 ff ff       	jmp    801057c4 <alltraps>
...
80106245:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010624a:	e9 75 f5 ff ff       	jmp    801057c4 <alltraps>
...
80106251:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106256:	e9 69 f5 ff ff       	jmp    801057c4 <alltraps>
...
8010625d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106262:	e9 5d f5 ff ff       	jmp    801057c4 <alltraps>
...
80106269:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010626e:	e9 51 f5 ff ff       	jmp    801057c4 <alltraps>
...
80106275:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010627a:	e9 45 f5 ff ff       	jmp    801057c4 <alltraps>
...
80106281:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106286:	e9 39 f5 ff ff       	jmp    801057c4 <alltraps>
...
8010628d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106292:	e9 2d f5 ff ff       	jmp    801057c4 <alltraps>
...
80106299:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010629e:	e9 21 f5 ff ff       	jmp    801057c4 <alltraps>
...
801062a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062aa:	e9 15 f5 ff ff       	jmp    801057c4 <alltraps>
...
801062b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062b6:	e9 09 f5 ff ff       	jmp    801057c4 <alltraps>
...
801062bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062c2:	e9 fd f4 ff ff       	jmp    801057c4 <alltraps>
...
801062c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062ce:	e9 f1 f4 ff ff       	jmp    801057c4 <alltraps>
...
801062d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062da:	e9 e5 f4 ff ff       	jmp    801057c4 <alltraps>
...
801062e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062e6:	e9 d9 f4 ff ff       	jmp    801057c4 <alltraps>
...
801062ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062f2:	e9 cd f4 ff ff       	jmp    801057c4 <alltraps>
...
801062f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062fe:	e9 c1 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106305:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010630a:	e9 b5 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106311:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106316:	e9 a9 f4 ff ff       	jmp    801057c4 <alltraps>
...
8010631d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106322:	e9 9d f4 ff ff       	jmp    801057c4 <alltraps>
...
80106329:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010632e:	e9 91 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106335:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010633a:	e9 85 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106341:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106346:	e9 79 f4 ff ff       	jmp    801057c4 <alltraps>
...
8010634d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106352:	e9 6d f4 ff ff       	jmp    801057c4 <alltraps>
...
80106359:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010635e:	e9 61 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106365:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010636a:	e9 55 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106371:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106376:	e9 49 f4 ff ff       	jmp    801057c4 <alltraps>
...
8010637d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106382:	e9 3d f4 ff ff       	jmp    801057c4 <alltraps>
...
80106389:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010638e:	e9 31 f4 ff ff       	jmp    801057c4 <alltraps>
...
80106395:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010639a:	e9 25 f4 ff ff       	jmp    801057c4 <alltraps>
...
801063a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063a6:	e9 19 f4 ff ff       	jmp    801057c4 <alltraps>
...
801063ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063b2:	e9 0d f4 ff ff       	jmp    801057c4 <alltraps>
...
801063b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063be:	e9 01 f4 ff ff       	jmp    801057c4 <alltraps>
...
801063c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063ca:	e9 f5 f3 ff ff       	jmp    801057c4 <alltraps>
...
801063d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063d6:	e9 e9 f3 ff ff       	jmp    801057c4 <alltraps>
...
801063dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063e2:	e9 dd f3 ff ff       	jmp    801057c4 <alltraps>
...
801063e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063ee:	e9 d1 f3 ff ff       	jmp    801057c4 <alltraps>
...
801063f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063fa:	e9 c5 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106401:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106406:	e9 b9 f3 ff ff       	jmp    801057c4 <alltraps>
...
8010640d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106412:	e9 ad f3 ff ff       	jmp    801057c4 <alltraps>
...
80106419:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010641e:	e9 a1 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106425:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010642a:	e9 95 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106431:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106436:	e9 89 f3 ff ff       	jmp    801057c4 <alltraps>
...
8010643d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106442:	e9 7d f3 ff ff       	jmp    801057c4 <alltraps>
...
80106449:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010644e:	e9 71 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106455:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010645a:	e9 65 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106461:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106466:	e9 59 f3 ff ff       	jmp    801057c4 <alltraps>
...
8010646d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106472:	e9 4d f3 ff ff       	jmp    801057c4 <alltraps>
...
80106479:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010647e:	e9 41 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106485:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010648a:	e9 35 f3 ff ff       	jmp    801057c4 <alltraps>
...
80106491:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106496:	e9 29 f3 ff ff       	jmp    801057c4 <alltraps>
...
8010649d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064a2:	e9 1d f3 ff ff       	jmp    801057c4 <alltraps>
...
801064a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ae:	e9 11 f3 ff ff       	jmp    801057c4 <alltraps>
...
801064b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064ba:	e9 05 f3 ff ff       	jmp    801057c4 <alltraps>
...
801064c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064c6:	e9 f9 f2 ff ff       	jmp    801057c4 <alltraps>
...
801064cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064d2:	e9 ed f2 ff ff       	jmp    801057c4 <alltraps>
...
801064d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064de:	e9 e1 f2 ff ff       	jmp    801057c4 <alltraps>
...
801064e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064ea:	e9 d5 f2 ff ff       	jmp    801057c4 <alltraps>
...
801064f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064f6:	e9 c9 f2 ff ff       	jmp    801057c4 <alltraps>
...
801064fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106502:	e9 bd f2 ff ff       	jmp    801057c4 <alltraps>
...
80106509:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010650e:	e9 b1 f2 ff ff       	jmp    801057c4 <alltraps>
...
80106515:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010651a:	e9 a5 f2 ff ff       	jmp    801057c4 <alltraps>
...
80106521:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106526:	e9 99 f2 ff ff       	jmp    801057c4 <alltraps>
...
8010652d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106532:	e9 8d f2 ff ff       	jmp    801057c4 <alltraps>
...
80106539:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010653e:	e9 81 f2 ff ff       	jmp    801057c4 <alltraps>
...
80106545:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010654a:	e9 75 f2 ff ff       	jmp    801057c4 <alltraps>
...
80106551:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106556:	e9 69 f2 ff ff       	jmp    801057c4 <alltraps>
...
8010655d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106562:	e9 5d f2 ff ff       	jmp    801057c4 <alltraps>
...
80106569:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010656e:	e9 51 f2 ff ff       	jmp    801057c4 <alltraps>
...
80106575:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010657a:	e9 45 f2 ff ff       	jmp    801057c4 <alltraps>
...
80106581:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106586:	e9 39 f2 ff ff       	jmp    801057c4 <alltraps>
...
8010658d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106592:	e9 2d f2 ff ff       	jmp    801057c4 <alltraps>
...
80106599:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010659e:	e9 21 f2 ff ff       	jmp    801057c4 <alltraps>
...
801065a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065aa:	e9 15 f2 ff ff       	jmp    801057c4 <alltraps>
...
801065b1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065b6:	e9 09 f2 ff ff       	jmp    801057c4 <alltraps>
...
801065bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065c2:	e9 fd f1 ff ff       	jmp    801057c4 <alltraps>
...
801065c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065ce:	e9 f1 f1 ff ff       	jmp    801057c4 <alltraps>
...
801065d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065da:	e9 e5 f1 ff ff       	jmp    801057c4 <alltraps>
...
801065e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065e6:	e9 d9 f1 ff ff       	jmp    801057c4 <alltraps>
...
801065ed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065f2:	e9 cd f1 ff ff       	jmp    801057c4 <alltraps>
...
801065f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065fe:	e9 c1 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106605:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010660a:	e9 b5 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106611:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106616:	e9 a9 f1 ff ff       	jmp    801057c4 <alltraps>
...
8010661d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106622:	e9 9d f1 ff ff       	jmp    801057c4 <alltraps>
...
80106629:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010662e:	e9 91 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106635:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010663a:	e9 85 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106641:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106646:	e9 79 f1 ff ff       	jmp    801057c4 <alltraps>
...
8010664d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106652:	e9 6d f1 ff ff       	jmp    801057c4 <alltraps>
...
80106659:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010665e:	e9 61 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106665:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010666a:	e9 55 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106671:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106676:	e9 49 f1 ff ff       	jmp    801057c4 <alltraps>
...
8010667d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106682:	e9 3d f1 ff ff       	jmp    801057c4 <alltraps>
...
80106689:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010668e:	e9 31 f1 ff ff       	jmp    801057c4 <alltraps>
...
80106695:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010669a:	e9 25 f1 ff ff       	jmp    801057c4 <alltraps>
...
801066a1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066a6:	e9 19 f1 ff ff       	jmp    801057c4 <alltraps>
...
801066ad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066b2:	e9 0d f1 ff ff       	jmp    801057c4 <alltraps>
...
801066b9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066be:	e9 01 f1 ff ff       	jmp    801057c4 <alltraps>
...
801066c5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066ca:	e9 f5 f0 ff ff       	jmp    801057c4 <alltraps>
...
801066d1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066d6:	e9 e9 f0 ff ff       	jmp    801057c4 <alltraps>
...
801066dd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066e2:	e9 dd f0 ff ff       	jmp    801057c4 <alltraps>
...
801066e9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066ee:	e9 d1 f0 ff ff       	jmp    801057c4 <alltraps>
...
801066f5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066fa:	e9 c5 f0 ff ff       	jmp    801057c4 <alltraps>
...
80106701:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106706:	e9 b9 f0 ff ff       	jmp    801057c4 <alltraps>
...
8010670d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106712:	e9 ad f0 ff ff       	jmp    801057c4 <alltraps>
...
8010677a:	e8 31 de ff ff       	call   801045b0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010681d:	68 38 79 10 80       	push   $0x80107938
...
801069a4:	0f 84 c2 00 00 00    	je     80106a6c <switchuvm+0xec>
  pushcli();
801069aa:	e8 f1 d8 ff ff       	call   801042a0 <pushcli>
...
80106abf:	e8 ec da ff ff       	call   801045b0 <memset>
...
80106af0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106af1:	e9 6a db ff ff       	jmp    80104660 <memmove>
    panic("inituvm: more than a page");
80106af6:	83 ec 0c             	sub    $0xc,%esp
80106af9:	68 7d 79 10 80       	push   $0x8010797d
...
80106c5d:	68 b5 79 10 80       	push   $0x801079b5
...
80106c93:	68 cd 79 10 80       	push   $0x801079cd
...
80106d9c:	68 e9 79 10 80       	push   $0x801079e9
...
80106dd0:	e8 db d7 ff ff       	call   801045b0 <memset>
...
80106e3b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e6f:	68 fa 79 10 80       	push   $0x801079fa
...
80106ec0:	e8 9b d7 ff ff       	call   80104660 <memmove>
...
80106f59:	68 1e 7a 10 80       	push   $0x80107a1e
80106f5e:	e8 2d 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f63:	83 ec 0c             	sub    $0xc,%esp
80106f66:	68 04 7a 10 80       	push   $0x80107a04
...
80106fef:	e8 6c d6 ff ff       	call   80104660 <memmove>
    len -= n;
    buf += n;
